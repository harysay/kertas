...
/// Copied from flutter framework, enables option to add border radius to tabs
/// Also default indicator and tab height is changed
///
...
class SMMTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// The border radius applied for each tab
  final BorderRadius tabBorderRadius;

  /// The padding applied for each tab
  ///
  /// Its the padding around the actual touch region
  final EdgeInsetsGeometry tabPadding;

  /// The padding applied for the whole tabbar
  ...
  @override
  _SMMTabBarState createState() => _SMMTabBarState();
}

class _SMMTabBarState extends State<SMMTabBar> {
